...
@Service
public class FiGeneratorService {
    ...
    public List<FI> newFis (String ndId, Long fiDocId,String json) throws ResourceNotFoundException, DataFactoryNotFoundException {
        FI[]fis=new FI[1];
