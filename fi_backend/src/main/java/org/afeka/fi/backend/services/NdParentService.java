...
@Service
public class NdParentService implements EntityService<NdParent> {
    ...
    @Override
    public NdParent add(ViewCreateRequest viewCreateRequest, String parentId) throws ResourceNotFoundException {
